  ...
  return (
    <div className="app-shell">
      ...
      <div className="workspace">
        ...
        {view === "develop" ? <DevelopView assets={assets} selected={selected} onSelect={(asset) => setSelectedId(asset.id)} onExport={exportImage} onRecipeSaved={() => { void refreshCatalogue(); }} /> : null}
