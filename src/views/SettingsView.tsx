...
export function SettingsView({ status, health, busy, onIntegrity, onBackup, onRestore, onRebuild, onDiagnostics }: Props) {
  return <main className="view settings-view">
    ...
    <div className="settings-grid">
      ...
      <section className="settings-card"><ShieldCheck size={22} /><div><h2>Local image editor</h2><p>{health.localAiDetail}</p><small>{health.localAiModel ?? "Qwen-Image-Edit is optional."}</small></div></section>
